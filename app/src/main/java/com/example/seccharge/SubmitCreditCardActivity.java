...
import com.example.seccharge.databinding.ActivitySubmitCreditCardBinding;
...
public class SubmitCreditCardActivity extends AppCompatActivity {
    ...
    private void submit() {
     ...
     //   Toast.makeText(SubmitCreditCardActivity.this, card.toString(), Toast.LENGTH_LONG).show();
        ...
        Intent i = new Intent(SubmitCreditCardActivity.this, com.example.seccharge.navigation_drawer.class);
        startActivity(i);
    }
